...
async def async_setup_platform(hass, config, async_add_entities, discovery_info=None):
    ...
    async_add_entities([DemoCamera("Demo camera")])([DemoCamera("Demo camera2")])([DemoCamera("Demo camera3")])([DemoCamera("Demo camera4")])
...
class DemoCamera(Camera):
    ...
    async def async_camera_image(self):
        ...
        self._images_index = (self._images_index + 1) % 2
        image_path = Path(__file__).parent / f"1_{self._images_index}.jpg"
